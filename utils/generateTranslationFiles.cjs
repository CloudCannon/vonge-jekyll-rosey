...
const inputFilePath = './site/rosey/base.json';
const inputURLFilePath = './site/rosey/base.urls.json';
const translationFilesDirPath = './site/rosey/translations';
const localesDirPath = './site/rosey/locales';
